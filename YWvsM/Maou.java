...
public class Maou {
	...
	static final int SCRATCH_DAMEGE = 20;
	...
	public void scratch(Wizard w){		//攻撃(ひっかく)	(魔法使い[クラス]のデータを引数として受け取る)
		w.hp -= SCRATCH_DAMEGE;					//魔法使いへ10のダメージ
		System.out.println(this.name + "の攻撃「ひっかく」");
		System.out.println(this.name + "は大きな爪の生えた腕を振り下ろす・・・" + w.name + "へ、" + SCRATCH_DAMEGE + "のダメージ");
		System.out.println(w.name + "の残りHP" + w.hp);
		System.out.println();
	}
	...
	public void bite(Wizard w){		//かみつく		(魔法使い[クラス]のデータを引数として受け取る)
		w.hp -= BITE_DAMAGE;		//魔法使いへ80のダメージ
		System.out.println(this.name + "の攻撃「かみつく」");
		System.out.println(this.name + "は鋭い牙と屈強な顎で噛みついた・・・" + w.name + "へ、" + BITE_DAMAGE + "のダメージ");
		System.out.println(w.name + "の残りHP" + w.hp);
		System.out.println();
	}
